...
enum Opcodes
{
    ...
    CMSG_RANDOMIZE_CHAR_NAME = 0x0B1C, // 18414
    SMSG_RANDOMIZE_CHAR_NAME = 0x169F, // 18414
	...
	SMSG_NEW_WORLD = 0x1C3B, // 18414
    SMSG_TRANSFER_PENDING = 0x061B, // 18414
    SMSG_TRANSFER_ABORTED = 0x0C8F, // 18414
    ...
    CMSG_GAMEOBJECT_QUERY = 0x1461, // 18414
    SMSG_GAMEOBJECT_QUERY_RESPONSE = 0x06BF, // 18414
	CMSG_CREATURE_QUERY = 0x0842, // 18414
	SMSG_CREATURE_QUERY_RESPONSE = 0x048B, // 18414
    CMSG_WHO = 0x18A3, // 18414 - Name not showing
    SMSG_WHO = 0x161B, // 18414
	CMSG_WHOIS = 0xBAD,
	SMSG_WHOIS = 0xBAD,
    CMSG_CONTACT_LIST = 0x0BB4, // 18414
    SMSG_CONTACT_LIST = 0x1F22, // 18414
    SMSG_FRIEND_STATUS = 0x0532, // 18414
    ...
    CMSG_MOVE_TELEPORT_ACK = 0x0078, // 18414
	MSG_MOVE_TOGGLE_FALL_LOGGING = 0xBAD,	// not used in client
	MSG_MOVE_FALL_LAND = 0x08FA, // 18414
    ...
    MSG_MOVE_SET_RUN_SPEED = 0x184C, // 18414 - SMSG
    ...
    MSG_MOVE_SET_SWIM_SPEED = 0x0817, // 18414 - SMSG
    ...
    SMSG_MONSTER_MOVE = 0x1A07, // 18414
	...
	SMSG_TRIGGER_CINEMATIC = 0x0B01, // 18414
    ...
    CMSG_STANDSTATECHANGE = 0x03E6,	// 18414
    ...
    CMSG_SWAP_ITEM = 0x035D, // 18414
	CMSG_SWAP_INV_ITEM = 0x03DF, // 18414
	CMSG_SPLIT_ITEM = 0xBAD,	// implemented
	CMSG_AUTOEQUIP_ITEM_SLOT = 0xBAD,	// implemented
	OBSOLETE_DROP_ITEM = 0xBAD,	// not used in client
    CMSG_DESTROYITEM = 0x0026, // 18414 - change the name to CMSG_DESTROY_ITEM
    ...
    CMSG_SET_ACTION_BUTTON = 0x1F8C, // 18414 [TODO}
    SMSG_ACTION_BUTTONS = 0x081A,	// 18414
	SMSG_INITIAL_SPELLS = 0x045A,	// 18414
    SMSG_LEARNED_SPELL = 0x129A,	// 18414
    ...
    CMSG_SET_SELECTION = 0x0740, // 18414
	...
	SMSG_ATTACKSWING_NOTINRANGE = 0x145, // UNHANLED
	SMSG_ATTACKSWING_BADFACING = 0x146, // UNHANDLED
    ...
    SMSG_DUEL_REQUESTED = 0x0022, // 18414
    SMSG_DUEL_OUTOFBOUNDS = 0x001A, // 18414
    SMSG_DUEL_INBOUNDS = 0x163A, // 18414
    SMSG_DUEL_COMPLETE = 0x1C0A, // 18414
    SMSG_DUEL_WINNER = 0x10E1, // 18414
    ...
    CMSG_GOSSIP_SELECT_OPTION = 0x0748, // 18414
    SMSG_GOSSIP_MESSAGE = 0x0244, // 18414
    SMSG_GOSSIP_COMPLETE = 0x034E, // 18414
    CMSG_NPC_TEXT_QUERY = 0x0287, // 18414
    SMSG_NPC_TEXT_UPDATE = 0x140A, // 18414
	SMSG_NPC_WONT_TALK = 0x181,	// not used in client
    CMSG_QUESTGIVER_STATUS_QUERY = 0x036A, // 18414
    SMSG_QUESTGIVER_STATUS = 0x1275, // 18414
    CMSG_QUESTGIVER_HELLO = 0x02DB, // 18414
    SMSG_QUESTGIVER_QUEST_LIST = 0x02D4, // 18414
    CMSG_QUESTGIVER_QUERY_QUEST = 0x12F0, // 18414
	CMSG_QUESTGIVER_QUEST_AUTOLAUNCH = 0x187,	// not used in client
    SMSG_QUESTGIVER_QUEST_DETAILS = 0x134C, // 18414
    CMSG_QUESTGIVER_ACCEPT_QUEST = 0x06D1, // 18414
    ...
    SMSG_QUESTLOG_FULL = 0x07FD, // 18414
	SMSG_QUESTUPDATE_FAILED = 0x1061,	// implemented
    SMSG_QUESTUPDATE_FAILEDTIMER = 0x06FF, // 18414
    SMSG_QUESTUPDATE_COMPLETE = 0x0776, // 18414
    SMSG_QUESTUPDATE_ADD_KILL = 0x1645, // 18414 SMSG_QUESTUPDATE_ADD_CREDIT
    ...
    CMSG_LIST_INVENTORY = 0x02D8, // 18414
    SMSG_LIST_INVENTORY = 0x1AAE, // 18414
    CMSG_SELL_ITEM = 0x1358, // 18414
    SMSG_SELL_ITEM = 0x048E, // 18414
    ...
    CMSG_PLAYED_TIME = 0x03F6, // 18414
    SMSG_PLAYED_TIME = 0x11E2, // 18414
    CMSG_QUERY_TIME = 0x0640,	// 18414
    SMSG_QUERY_TIME_RESPONSE = 0x100F,	// 18414
    SMSG_LOG_XPGAIN = 0x1E9A, // 18414
	SMSG_AURACASTLOG_OBSOLETE = 0x1D1,	// OBSOLETE
    CMSG_RECLAIM_CORPSE = 0x03D3, // 18414
	CMSG_WRAP_ITEM = 0x1D3,	// implemented
    SMSG_LEVELUP_INFO = 0x1961,	// 18414
    ...
    SMSG_PLAY_SPELL_VISUAL = 0x061E, // 18414
    ...
    CMSG_REQUEST_ACCOUNT_DATA = 0x1D8A,	// 18414
	CMSG_UPDATE_ACCOUNT_DATA = 0x0068,	// 18414
    SMSG_UPDATE_ACCOUNT_DATA = 0x0AAE,	// 18414
    ...
    SMSG_CORPSE_QUERY = 0x0E0B, // 18414
    ...
    CMSG_SPIRIT_HEALER_ACTIVATE = 0x0340, // 18414
    ...
    SMSG_SPIRIT_HEALER_CONFIRM = 0x1EAA, // 18414
	CMSG_CHARACTER_POINT_CHEAT = 0x223,	// GM client only
    SMSG_GOSSIP_POI = 0x0785, // 18414
    ...
    CMSG_SEND_MAIL = 0x1DBA, // 18414
	SMSG_SEND_MAIL_RESULT = 0x239,	// implemented
    CMSG_GET_MAIL_LIST = 0x077A, // 18414
    SMSG_MAIL_LIST_RESULT = 0x1C0B, // 18414
	...
	CMSG_ITEM_TEXT_QUERY = 0x243, // Removed
	SMSG_ITEM_TEXT_QUERY_RESPONSE = 0x244, // Removed
    CMSG_MAIL_TAKE_MONEY = 0x06FA, // 18414
    CMSG_MAIL_TAKE_ITEM = 0x1371, // 18414
    CMSG_MAIL_MARK_AS_READ = 0x0241, // 18414
    CMSG_MAIL_RETURN_TO_SENDER = 0x1FA8, // 18414
    CMSG_MAIL_DELETE = 0x14E2, // 18414
    CMSG_MAIL_CREATE_TEXT_ITEM = 0x1270, // 18414
	SMSG_SPELLLOGMISS = 0x24B,	// implemented
    SMSG_SPELLLOGEXECUTE = 0x00D8, // 18414!
    ...
    SMSG_CORPSE_RECLAIM_DELAY = 0x022A, // 18414
	CMSG_SET_ACTIVE_MOVER = 0x09F0, // 18414
    ...
    MSG_QUERY_NEXT_MAIL_TIME = 0x089B, // 18414
    ...
    SMSG_STANDSTATE_UPDATE = 0x1C12, // 18414
    ...
    SMSG_DUEL_COUNTDOWN = 0x129F, // 18414
	SMSG_AREA_TRIGGER_MESSAGE = 0x2B8,	// implemented
    CMSG_TOGGLE_HELM = 0x126B, // 18414
    CMSG_TOGGLE_CLOAK = 0x02F2, // 18414
    ...
    CMSG_CHAR_RENAME = 0x0963,	// implemented
	SMSG_CHAR_RENAME = 0x2C8,	// 18414
    CMSG_MOVE_SPLINE_DONE = 0x0CBF,	// 18414
    ...
    CMSG_MOVE_TIME_SKIPPED = 0x0150, // 18414
    ...
    SMSG_ADDON_INFO = 0x160A, // 18414
	CMSG_PET_UNLEARN = 0x2F0,	// implemented
	SMSG_PET_UNLEARN_CONFIRM = 0x0000,	// implemented
    ...
    MSG_MOVE_START_ASCEND = 0x11FA, // 18414
    MSG_MOVE_STOP_ASCEND = 0x115A, // 18414
	...
	SMSG_LFG_AUTOJOIN_FAILED_NO_PLAYER = 0x0000,	// implemented
    ...
    SMSG_DEATH_RELEASE_LOC = 0x1063, // 18414
    ...
    MSG_MOVE_SET_FLIGHT_SPEED = 0x006E, // 18414 - SMSG
	...
	CMSG_SET_ACTIVE_VOICE_CHANNEL = 0xBAD, // implemented
    ...
    CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY = 0x02F1, // 18414
	SMSG_QUESTGIVER_STATUS_MULTIPLE = 0x06CE, // 18414
    ...
    SMSG_ENABLE_BARBER_SHOP = 0x1222, // 18414
    ...
    SMSG_CRITERIA_UPDATE = 0x0E9B, // 18414
    CMSG_QUERY_INSPECT_ACHIEVEMENTS = 0x0373, // 18414
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS = 0x009E, // 18414
    ...
    SMSG_PRE_RESURRECT = 0x19C0, // 18414
    ...
    SMSG_CRITERIA_DELETED = 0x1C33, // 18414
    ...
    CMSG_WORLD_STATE_UI_TIMER_UPDATE = 0x15AB,	// 18414
    SMSG_WORLD_STATE_UI_TIMER_UPDATE = 0x0027,	// 18414
	...
	CMSG_MESSAGECHAT_SAY = 0x0A9A, // 18414
	CMSG_MESSAGECHAT_YELL = 0x04AA, // 18414
	CMSG_MESSAGECHAT_CHANNEL = 0x00BB, // 18414
	CMSG_MESSAGECHAT_WHISPER = 0x123E, // 18414
	CMSG_MESSAGECHAT_GUILD = 0x0CAE, // 18414
	CMSG_MESSAGECHAT_OFFICER = 0x0ABF, // 18414
	CMSG_MESSAGECHAT_AFK = 0x0EAB, // 18414
	CMSG_MESSAGECHAT_DND = 0x002E, // 18414
	CMSG_MESSAGECHAT_EMOTE = 0x103E, // 18414
	CMSG_MESSAGECHAT_PARTY = 0x109A, // 18414
	CMSG_MESSAGECHAT_RAID = 0x083E, // 18414
	CMSG_MESSAGECHAT_RAID_WARNING = 0x16AB, // 18414
	CMSG_MESSAGECHAT_BATTLEGROUND = 0x0000, // unknown
