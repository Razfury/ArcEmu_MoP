...
SERVER_DECL DBCStorage<SkillLineAbilityEntry>		dbcSkillLineAbilityEntry;
...
bool LoadDBCs()
{
    ...
    LOAD_DBC("DBC/SkillLineAbility.dbc", SkillLineAbilityFmt, false, dbcSkillLineAbilityEntry, false);
