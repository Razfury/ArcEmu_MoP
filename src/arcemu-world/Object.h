...
enum HIGHGUID_TYPE
{
    HIGHGUID_TYPE_PLAYER = 0x000,
	HIGHGUID_TYPE_WAYPOINT = 0x1000, // gone?
    HIGHGUID_TYPE_ITEM = 0x400,
    HIGHGUID_TYPE_CONTAINER = 0x400,
    HIGHGUID_TYPE_GAMEOBJECT = 0xF11,
    HIGHGUID_TYPE_TRANSPORTER = 0xF12,
    HIGHGUID_TYPE_CREATURE = 0xF13,
    HIGHGUID_TYPE_UNIT = 0xF13,
    HIGHGUID_TYPE_PET = 0xF14,
    HIGHGUID_TYPE_VEHICLE = 0xF15,
    HIGHGUID_TYPE_DYNAMICOBJECT = 0xF10,
    HIGHGUID_TYPE_CORPSE = 0xF101,
	HIGHGUID_TYPE_AREATRIGGER = 0xF102,
    HIGHGUID_TYPE_BATTLEGROUND = 0x1F1,
    HIGHGUID_TYPE_MO_TRANSPORT = 0x1FC,
    HIGHGUID_TYPE_GROUP = 0x1F5,
    HIGHGUID_TYPE_GUILD = 0x1FF,
	//===============================================
