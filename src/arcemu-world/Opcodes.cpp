...
NameTableEntry g_worldOpcodeNames[] = {
    ...
    { CMSG_DUEL_PROPOSED, "CMSG_DUEL_PROPOSED" },
    { CMSG_DUEL_RESPONSE, "CMSG_DUEL_RESPONSE" },
    ...
    { SMSG_CORPSE_QUERY, "SMSG_CORPSE_QUERY" },
    ...
    { CMSG_CORPSE_QUERY, "CMSG_CORPSE_QUERY" },
    { SMSG_DB_REPLY, "SMSG_DB_REPLY" },
